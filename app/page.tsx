...
import { 
  ...
  Star, Ruler, BedDouble, Check, Info, Loader, Zap, Wifi, Flame, Droplet, Thermometer, Wind,
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="fixed inset-0 z-[70] bg-black flex flex-col">
      ...
      <div className="p-6 pb-10 flex gap-4 border-t border-white/5 bg-black">
        ...
        >
          {loading ? <Loader size={14} className="animate-spin" /> : (step === 4 ? "Tugatish" : "Keyingisi")} 
                    ...
                    {profileView === 'edit' && (
                      <div className="space-y-6 text-left">
                        ...
                        <div className="flex gap-3 pt-4">
                          ...
                          >
                            {savingProfile ? <Loader size={12} className="animate-spin" /> : "Saqlash"}
                          </button>
                        </div>
                      </div>
                    )}
